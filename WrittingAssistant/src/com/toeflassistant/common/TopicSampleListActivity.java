...
//							OffersAdSize.SIZE_MATCH_SCREENx60);// 传入高度为60dp的OffersAdSize来定义积分Banner
...
//		this.addContentView(banner, layoutParams);
	...
	public class SampleListAdapter extends CursorAdapter {
		...
		@Override
		public View newView(Context mContext, Cursor mCursor, ViewGroup mViewGroup) {
			...
			TextView sampleDescription = (TextView) view.findViewById(R.id.sample_description);
		...
		public void bindView(View view, Context arg1, Cursor cursor) {
			...
			((TextView) view
					.getTag(R.id.sample_id))
					.setText("sample #" + (1 + cursor.getPosition()) + " ");
			((TextView) view
					.getTag(R.id.sample_description))
					.setText(cursor.getString(1).replaceAll("/////", "\n\n").trim());
		}
