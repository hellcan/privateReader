...
public class TopicDetailActivity extends Activity implements ToolTipView.OnToolTipViewClickedListener{
	String questionId;
	String topicContent;
	...
	public void onCreate(Bundle savedInstanceState){
		...
		TextView question = (TextView)this.findViewById(R.id.item_detail_question_description);
