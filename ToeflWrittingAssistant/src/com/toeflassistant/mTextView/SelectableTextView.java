	...
	public void initPopuptWindow() {
        ...
        btnCopy.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {				
                ...
                final View view = inflater.inflate(R.layout.popup_dialog_activity, null);// 获得自定义对话框
                AlertDialog.Builder dialog = new AlertDialog.Builder(getContext());
                dialog.setTitle("Choose Category");
                dialog.setView(view);
                final Spinner s = (Spinner)view.findViewById(R.id.spinner);
				String[] m ={"Head", "Transition", "Ending", "Summarize", "Sentence", "Word","Other"};
